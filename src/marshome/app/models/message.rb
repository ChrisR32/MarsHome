...
#      Notification.create(content: "New message from #{sender.first_name}", user_id: self.conversation.recipient_id)
#     else
#      sender = User.find(self.conversation.recipient_id)
#      Notification.create(content: "New message from #{sender.first_name}", user_id: self.conversation.sender_id)
#     end
# end
end
